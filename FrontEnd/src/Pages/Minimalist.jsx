...
const Minimalist = () => {
  ...
  useEffect(() => {
    const fetchMinimalistProducts = async () => {
      try {
        setLoading(true);
        ...
        console.error("Error fetching minimalist products:", error);
    ...
    <div className="collections-wrapper py-4 px-3 px-md-4">
      <Container fluid className="px-0">
        <div className="collection-header d-flex justify-content-between align-items-center mb-4">
            <h2 className="collection-title">Minimalist Collection</h2>
        ...
        {!loading && products.length === 0 && !error && (
          <div className="text-center py-5">
            <p className="fs-4">No minimalist art products available.</p>
          </div>
        )}
                ...
                >
                  <div className="card-img-wrapper">
                    <Card.Img
                      ...
                      alt={product.productName || "Minimalist Art"}
      ...
      <style jsx>{`
        ...
        /* Product cards - matching WabiSabi style */
        .product-col {
          padding: 0 15px;
        }
